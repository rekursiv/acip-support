...
public class TaskView extends Composite {
	 ...
	 */
	public TaskView(Composite parent, int style, Injector injector) {
		super(parent, style);
		...
		fd_lblGenericTaskPanel.bottom = new FormAttachment(0, 45);
		fd_lblGenericTaskPanel.right = new FormAttachment(0, 280);
		fd_lblGenericTaskPanel.top = new FormAttachment(20, -15);
